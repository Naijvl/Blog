...
<div class="comments_con" class="comments_area">
	<h2 class="cmtit">评论区</h2>
	<?php if ( have_comments() ) : ?>
	<div id="comment-list">
		<ul class="comment_entry">
		<?php
		wp_list_comments( 
			array(
				'style' => 'ul',
	...
	'fields' => apply_filters( 'comment_form_default_fields', array(
		'author' => '<div class="uinfo"><p class="comment-form-author"><label for="author">昵称&nbsp;&nbsp;</label><input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" required="required"  placeholder="必填"/></p>',
